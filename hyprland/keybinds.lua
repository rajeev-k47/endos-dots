...
hl.bind("SUPER + N", hl.dsp.exec_cmd("caelestia toggle communication"), { description = "Shell: Toggle right sidebar" })
...
hl.bind("SUPER + M", hl.dsp.exec_cmd(hyprScripts .. "/toggle-music.sh"))
hl.bind(
	"SUPER + G",
	hl.dsp.exec_cmd(hyprScripts .. "/toggle-communication.sh"),
	{ description = "Shell: Toggle widget overlay" }
)
hl.bind(
	"CTRL + ALT + Delete",
...
hl.bind("CTRL + H", hl.dsp.exec_cmd(qsScripts .. "/toggle-cursor.sh"))
hl.bind(
	"CTRL + SUPER + R",
...
hl.bind(
	...
	{ locked = true, description = "Misc: Suspend system" }
) -- Sleep
...
hl.bind(
	...
	{ locked = true, description = "Misc: Previous track" }
)
hl.bind(
	"SUPER + SHIFT + P",
