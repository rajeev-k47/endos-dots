...
hl.bind("SUPER + G", hl.dsp.exec_cmd(hyprScripts .. "/toggle-communication.sh"))
hl.bind("SUPER + H", hl.dsp.global("quickshell:overlayToggle"), { description = "Shell: Toggle widget overlay" })
hl.bind(
	"CTRL + ALT + Delete",
...
hl.bind("CTRL + R", hl.dsp.exec_cmd(qsScripts .. "/toggle-cursor.sh"))
hl.bind(
	"CTRL + SUPER + R",
